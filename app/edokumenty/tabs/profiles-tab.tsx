...
// Profile użytkowników (te same co w Portalu)
const profilesData = [
  { id: 1, name: "Administrator", description: "Pełny dostęp do systemu", groupsCount: 8 },
  { id: 2, name: "Księgowy", description: "Dostęp do funkcji księgowych", groupsCount: 5 },
  { id: 3, name: "Handlowiec", description: "Dostęp do funkcji sprzedażowych", groupsCount: 4 },
  { id: 4, name: "Sekretariat", description: "Podstawowy dostęp do dokumentów", groupsCount: 3 },
  { id: 5, name: "Kierownik", description: "Dostęp zarządczy", groupsCount: 6 },
  { id: 6, name: "Pracownik", description: "Podstawowy dostęp do systemu", groupsCount: 2 },
]
...
export function ProfilesTab() {
  ...
  const handleEditProfile = (profile: any) => {
    ...
    } else if (profile.name === "Handlowiec") {
      setSelectedGroups([2, 6])
    } else if (profile.name === "Sekretariat") {
      setSelectedGroups([4, 6])
    } else if (profile.name === "Kierownik") {
      setSelectedGroups([2, 3, 5, 6])
    } else {
      setSelectedGroups([6])
    }
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button className="bg-green-600 hover:bg-green-700 text-white" onClick={handleAddProfile}>
