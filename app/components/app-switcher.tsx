...
export function AppSwitcher() {
  ...
  const apps = [
    ...
    },
    {
      ...
      shortName: "PM",
      icon: "/app-icons/policy-icon.png",
      color: "#16A34A",
      ...
      {isOpen && (
        <div className="absolute top-full right-0 mt-1 w-80 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
          <div className="p-4">
            ...
            {/* Poszerz ikony aplikacji do kształtu kwadratu i nadaj min-width dla ikon z jedną literą */}
            {/* Zaktualizuj style dla ikon aplikacji */}
            <div className="grid grid-cols-3 gap-4">
              {apps.map((app) => (
                ...
                >
                  <div
                    className="w-12 h-12 rounded-lg flex items-center justify-center mb-2 min-w-[48px]"
