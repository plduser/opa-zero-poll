...
-- Insert companies (without nip - not in schema)
...
INSERT INTO user_tenants (user_id, tenant_id, is_default, is_active, assigned_by, notes) VALUES
-- Użytkownicy w tenant125
('user42', 'tenant125', true, true, 'enhanced_seed', 'FK+HR Administrator'),
('user99', 'tenant125', true, true, 'enhanced_seed', 'HR Manager'),
('user150', 'tenant125', true, true, 'enhanced_seed', 'CRM Sales Manager'),
('user200', 'tenant125', true, true, 'enhanced_seed', 'Super Admin'),
('user300', 'tenant125', true, true, 'enhanced_seed', 'FK Księgowy + KSEF Księgowa'),
('user500', 'tenant125', true, true, 'enhanced_seed', 'KSEF Handlowiec'),
('user600', 'tenant125', true, true, 'enhanced_seed', 'eDokumenty Księgowa'),
('user700', 'tenant125', true, true, 'enhanced_seed', 'eBiuro Specjalista'),
('user800', 'tenant125', true, true, 'enhanced_seed', 'Developer podstawowe uprawnienia'),
-- Użytkownicy w tenant200
('user400', 'tenant200', true, true, 'enhanced_seed', 'External Accountant'),
-- Multi-tenant access
('user200', 'tenant200', false, true, 'enhanced_seed', 'Super Admin - dodatkowy tenant'),
('user200', 'tenant300', false, true, 'enhanced_seed', 'Super Admin - tenant testowy');
...
SELECT uap.user_id, ap.profile_id, uap.tenant_id, 'system'
FROM (VALUES
    -- user42 - FK i HR Administrator profiles
    ('user42', 'fk', 'Administrator', 'tenant125'),
    ('user42', 'hr', 'Administrator', 'tenant125'),
    -- user99 - HR Manager profile
    ('user99', 'hr', 'HR Manager', 'tenant125'),
    -- user150 - CRM Sales Manager profile
    ('user150', 'crm', 'Sales Manager', 'tenant125'),
    ...
    ('user200', 'ksef', 'Administrator', 'tenant125'),
    -- user300 - Standard accountant - FK Księgowy i KSEF Księgowa
    ('user300', 'fk', 'Księgowy', 'tenant125'),
    ('user300', 'ksef', 'Księgowa', 'tenant125'),
    -- user500 - KSEF specialist
    ('user500', 'ksef', 'Handlowiec', 'tenant125'),
    -- user600 - eDokumenty user
    ('user600', 'edokumenty', 'Księgowa', 'tenant125'),
    -- user700 - eBiuro specialist
    ('user700', 'ebiuro', 'Specjalista', 'tenant125'),
    -- user800 - Developer z podstawowymi uprawnieniami
    ('user800', 'fk', 'Użytkownik', 'tenant125'),
    ('user800', 'hr', 'Użytkownik', 'tenant125'),
    ('user800', 'crm', 'Użytkownik', 'tenant125'),
    -- user400 - External accountant w tenant200
...
BEGIN
    ...
    RAISE NOTICE '==================================================';
END $$; -- Enhanced Seed Data Part 2 - Permissions and User Assignments
...
JOIN roles r ON r.app_id = ur.app_id AND r.role_name = ur.role_name; -- Enhanced Seed Data Part 3 - Teams (REBAC) and Verification
