...
class ProvisioningAPITestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Zapisujemy oryginalną wartość DATABASE_PATH
        self.original_db_path = getattr(app, 'DATABASE_PATH', None)
    ...
    def tearDown(self):
        ...
        # Przywracamy oryginalną wartość DATABASE_PATH
        if self.original_db_path:
            os.environ['DATABASE_PATH'] = self.original_db_path
            app.DATABASE_PATH = self.original_db_path
        else:
            os.environ.pop('DATABASE_PATH', None)
            app.DATABASE_PATH = "tenants.db"
